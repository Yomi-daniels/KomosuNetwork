              ...
              <div className={styles.webDesignContent}>
                ...
                <div className={styles.WebDesignFeatures}>
                  ...
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Inform customers about ongoing promotions, discounts, and
                      special events.
                    </p>
                  </div>
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Provide real-time assistance on your dealership’s website.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.webDesignContent}>
                ...
                <div className={styles.WebDesignFeatures}>
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Develop engaging promotional videos tailored to help
                      captivate your audience and drive sales.
                    </p>
                  </div>
                  <div className={styles.WebDesignFeaturesContent}>
                    <div className={styles.webFeaturesImgShadow}>
                    ...
                    <p>
                      Provide valuable insights and guides to your clients
                      through blogs writing, maintenance tips on your websites
                      or platforms.
                    </p>
                  </div>
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Design and distribute regular newsletters with updates,
                  ...
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Continuously refine your content strategy based on
              ...
              <div className={styles.webDesignContent}>
                ...
                <div className={styles.WebDesignFeatures}>
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Use targeted advertising campaigns through the use of
                      relevant Ads to target what potential customers are
                      looking for.
                    </p>
                  </div>
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Improve your website’s ranking on search engines to
                  ...
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Send regular updates, promotions, and valuable content to
                  ...
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Deliver targeted offers based on customer preferences and
                      behavior.
                    </p>
                  </div>
                  <div className={styles.WebDesignFeaturesContent}>
                    ...
                    <p>
                      Seamlessly integrate our AI with your CRM system to manage
                      and track leads.
                    </p>
                  </div>
                </div>

...
const WebDesignWorks = () => {
  return <section className={webstyle.webWorksSection}>
   <h2 className={webstyle.WebHeader}>Our <span className={`${webstyle.headerSpan} ${shadowsFont.className}`}>Past</span> Works</h2>
            ...
            <div className={webstyle.webdesignContentsContainer}>
                <div className={webstyle.webdesignContents1}>
                    <div className={webstyle.webdesignTextContent}>
                        <h2>Tailored website designs that reflect your brand’s identity and values.</h2>

...
const Aipricing = () => {
  return <section className={Aistyles.AipricingSection}>
  <div className={Aistyles.AipricingHeader}>
    <h2>Pricing <span className={`${Aistyles.Aispan} ${shadowsFont.className}`}>Plans</span></h2>
  ...
  <div className={webstyle.WebPricingContainer}>
        ...
        <div className={webstyle.webPricingContents}>
            <div className={webstyle.webBasicPlan}>
                <h4>BASIC PLAN</h4>
                <p>Get your business up and running with our starter plan tailored for your needs</p>
                <h3>$2,000<span>/month</span></h3>
            ...
            <div className={`${webstyle.webBasicPlan} ${webstyle.webPremiumPlan} ${webstyle.enterprisePlan}`}>
                <h4>ENTERPRISE PLAN</h4>
                <p>Expand your brand offerings and get the best package to grow your audience</p>
                <h3>$10,000<span>/month</span></h3>
            ...
            <div className={webstyle.webbasicplanfeatures}>
                    ...
                    <div className={webstyle.webbasicplanfeaturesContent}>
                        ...
                        <p>Extensive training on how to update content and manage features</p>
                    </div>
                    <div className={webstyle.webbasicplanfeaturesContent}>
                        <div className={webstyle.tickImgBg}>
                            <div className={webstyle.tickImg}>
                    ...
                    <div className={webstyle.webbasicplanfeaturesContent}>
                        ...
                        <p>6 months post-launch support for bug fixes, updates, and content changes</p>
                    </div>
                </div>
            </div>
            <div className={`${webstyle.webBasicPlan} ${webstyle.webStandardPlan}`}>
                <h4>STANDARD PLAN</h4>
                <p>Get your business up and running with our Standard plan tailored for your needs</p>
                <h3>$5,000<span>/month</span></h3>
                ...
                <div className={webstyle.webbasicplanfeatures}>
                    ...
                    <div className={webstyle.webbasicplanfeaturesContent}>
                        ...
                        <p>3 months post-launch support for bug fixes and minor updates</p>
                    </div>
                </div>
            </div>
        </div>

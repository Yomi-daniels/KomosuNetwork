...
const ContentPricing = () => {
  return <section className={contentStyles.contentpricingsection}>
    <div className={contentStyles.ContentPricingHeader}>
            <h2>
            Pricing <span className={`${contentStyles.contentspan} ${shadowsFont.className}`}>Plans</span> 
            </h2>
        ...
        <div className={webstyle.webPricingContents}>
            ...
            <div className={`${webstyle.webBasicPlan} ${webstyle.webPremiumPlan}`}>
                <h4>PREMIUM PLAN</h4>
